...
const purchaseFlat = document.getElementById("purchase");
purchaseFlat.addEventListener("click", () => {
    purchaseFlat.innerHTML =  "Votre achat a été validé et votre carte bleue débitée";
    window.dataLayer = window.dataLayer || [];
...
const purchase = document.getElementById("purchase-flat");
